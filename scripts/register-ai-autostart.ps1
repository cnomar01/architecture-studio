...
$scriptPath = Join-Path $PSScriptRoot "start-ai-stack.ps1"
...
Write-Host "Registered $taskName for $env:USERNAME. Ollama and ComfyUI will start when this Windows account signs in."
