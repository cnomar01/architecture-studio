        ...
        <header className="flex flex-col justify-between gap-4 border-b border-white/10 pb-7 md:flex-row md:items-end">
          <div>
            ...
            <p className="mt-2 text-sm text-white/40">
              Live operational overview across projects, people, work and
              finance.
            </p>
          </div>
            ...
            <div className="mt-5 space-y-3">
              {projects.slice(0, 5).map((project) => (
                <Link
                  ...
                  className="flex items-center justify-between rounded-2xl border border-white/10 p-4 hover:bg-white/5"
                >
                  <div>
              ...
              {team.map((item) => (
                ...
                >
                  <div>
                    ...
                    <div className="mt-1 text-xs text-white/35">
                      {item.member.role} · {item.activeTasks} active tasks
                    </div>
                  </div>
